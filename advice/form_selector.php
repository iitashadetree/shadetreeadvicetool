...
echo "</select>"."<label>1. Select country of Interest</label></div>";
echo "</br>";
...
echo "</select>"."<label>2. Select region </label></div>";
...
echo "</select>"."<label>3. Select crop </label></div>";
echo "</br>";
...
echo "</select>"."<label>4. Select subzone</label></div>";
